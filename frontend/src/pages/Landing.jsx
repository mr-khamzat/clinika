        ...
        <div className="ks-hero-inner">
          <FadeIn>
            ...
            <div className="ks-hero-downloads">
              <a href="/downloads/KliniknetCalls-Setup-1.0.22.exe" download className="ks-btn-ghost">
          ...
          <div className="ks-calls-card">
            <div className="ks-calls-text">
              ...
              <div className="ks-hero-actions" style={{ flexWrap: 'wrap' }}>
                <a href="/downloads/KliniknetCalls-Setup-1.0.22.exe" download className="ks-btn-primary">
