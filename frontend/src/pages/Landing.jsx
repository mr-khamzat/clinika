 ...
 *   - Скачивание Calls для Windows / macOS (Win 1.0.11, Mac 1.0.7 arm64/x64)
 *
        ...
        <div className="ks-hero-inner">
          <FadeIn>
            ...
            <div className="ks-hero-downloads">
              <a href="/downloads/KliniknetCalls-Setup-1.0.11.exe" download className="ks-btn-ghost">
                {ICONS.download} Calls Win 1.0.11
              </a>
          ...
          <div className="ks-calls-card">
            <div className="ks-calls-text">
              ...
              <p className="ks-section-sub">
                ...
                Версия 1.0.11 — adaptive bitrate, RNNoise, update flow.
              </p>
              <div className="ks-hero-actions" style={{ flexWrap: 'wrap' }}>
                <a href="/downloads/KliniknetCalls-Setup-1.0.11.exe" download className="ks-btn-primary">
                  {ICONS.download} Windows · 1.0.11
                </a>
            ...
            <div className="ks-calls-mock">
              <div className="ks-preview-chrome">
                <div className="ks-preview-dots"><span /><span /><span /></div>
                <div className="ks-preview-url">КлиникСеть Calls · 1.0.11</div>
              </div>
