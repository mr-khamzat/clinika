 ...
 * ========================================
 * WARNING: dublicate, sync changes from PatientCabinet manually.
 * Этот файл — параллельный preview (URL /{slug}/p-new) для нового тёмного дизайна.
 * Он НЕ заменяет PatientCabinet.jsx, а развивается отдельно. При изменении логики
 * авторизации, session/manifest или важных API-вызовов в PatientCabinet.jsx — повторить
 * руками здесь. Удалить можно будет когда preview мигрирует в основной кабинет.
 * ========================================
