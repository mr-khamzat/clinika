...
- 5 неудачных попыток логина на учётку за 5 минут → блокировка на 30 минут.
- 20 попыток с одного IP за минуту → 429 + cooldown.
- При 100 попытках с IP за час → IP в blacklist на 24 часа.
