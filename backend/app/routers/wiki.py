...
STARTER_PAGES = [
    {
        ...
        "sort_order": 0,
        "parent_id": None,
        "content_md": """# Обзор платформы КлиникСеть

**КлиникСеть** — многотенантная SaaS-платформа для управления направлениями, пациентами, персоналом и финансами медицинских клиник.
