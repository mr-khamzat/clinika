...
class Tenant(Base):
    ...
    legal_kpp:          Mapped[str | None] = mapped_column(String(20),  nullable=True)
    legal_ogrn:         Mapped[str | None] = mapped_column(String(20),  nullable=True)
    legal_phone:        Mapped[str | None] = mapped_column(String(30),  nullable=True)
    legal_email:        Mapped[str | None] = mapped_column(String(200), nullable=True)
    legal_bank_name:    Mapped[str | None] = mapped_column(String(300), nullable=True)
    legal_bank_account: Mapped[str | None] = mapped_column(String(30),  nullable=True)
    legal_bank_bik:     Mapped[str | None] = mapped_column(String(12),  nullable=True)
    legal_bank_corr:    Mapped[str | None] = mapped_column(String(30),  nullable=True)
    legal_signer_name:  Mapped[str | None] = mapped_column(String(200), nullable=True)
